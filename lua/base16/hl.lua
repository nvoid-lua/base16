...
local hl_files = vim.fn.stdpath "data" .. "/site/pack/lazy/opt/base16/lua/base16/integrations"

for _, file in ipairs(vim.fn.readdir(hl_files)) do
   local integration = require("base16.integrations." .. vim.fn.fnamemodify(file, ":r"))

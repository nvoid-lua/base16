...
local defaults = {
  WinBar = { bg = colors.black },       -- window bar
  WinBarNC = { bg = colors.black },   -- window bar in inactive windows
...
local hexcolor = require("base16").turn_str_to_color
local new_hl = nvoid.ui.hl_add
return merge_tb(defaults, hexcolor(new_hl))

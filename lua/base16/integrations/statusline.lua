...
return {
	...
	NvoidInfoHeader = { bg = colors.blue, fg = colors.black },
	NvoidInfoBullet = { fg = colors.blue },
	NvoidInfoHeaderBuffer = { bg = colors.blue, fg = colors.black },
	NvoidInfoHeaderLsp = { bg = colors.green, fg = colors.black },
	NvoidInfoHeaderLint = { bg = colors.yellow, fg = colors.black },
	NvoidInfoHeaderFormat = { bg = colors.purple, fg = colors.black },
	NvoidInfoIdentifier = { fg = colors.white },
}
